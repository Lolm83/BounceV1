...
public:
	...
	void Centre( char* a_String, int y1, Pixel color, int scale_factor );
	void Print( char* a_String, int x1, int y1, Pixel color, int scale_factor );
...
public:
	...
	void DrawRotated(int a_X, int a_Y, int scale_factor, Surface* a_Target, int direction);
